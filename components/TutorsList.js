...
function TutorsList() {
  ...
  return (
    <main
      className="flex relative h-[calc(100vh-79px)] snap-y snap-mandatory overflow-scroll overflow-x-hidden scroll-smooth transition delay-150 duration-1000 ease-in-out w-full max-w-[calc(1440px-160px)] items-center justify-evenly gap-y-[6rem] gap-x-2  py-11 lg:justify-around flex-wrap mx-auto">
      ...
      {openPopUp.calendarPopUp && (
        <div className='flex items-center justify-center w-full absolute z-40 bg-red-50/25'>
