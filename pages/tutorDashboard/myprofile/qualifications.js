...
const Qualifications = () => {
  ...
  return (
    <div className=" bg-white sm:ml-[30px] sm:mt-[34px] sm:mb-[30px] sm:rounded-2xl ">
      <h1 className="mt-3 ml-12 text-3xl  font-semibold text-[#3d3d3d] xl:px-20">
        Qualifications
      </h1>
      <p className="mt-7 border-b"></p>
        ...
        <>
          ...
          >
            {(formik) => {
              ...
              return (
                <Form>
                  <div className="className=xs:mx-0 xs:m-0 xs:p-0  sm:mx-auto sm:p-4">
                        ...
                        return (
                          <>
                            {qualification.map((qualification, index) => (
                              <div>
                                <div className="mt-9 grid grid-cols-12 gap-5 p-4 sm:bg-[#F2F2F2] md:gap-x-8 md:p-[26px]">
                                  <div
                                    className="col-span-6 md:col-span-3"
                                    key={index}
                                  >
                                    <p className="mb-5 font-semibold xs:text-[13px] sm:overflow-hidden sm:overflow-ellipsis sm:whitespace-nowrap sm:text-[16px] ">
                                      Qualification Type
                                    </p>
                                    <Field
                                      as="select"
                                  ...
                                  <div className="col-span-6 md:col-span-3">
                                    <p className=" mb-5 overflow-hidden overflow-ellipsis whitespace-nowrap font-semibold xs:text-[13px] sm:text-[16px]">
